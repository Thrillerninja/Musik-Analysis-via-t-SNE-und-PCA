...
\documentclass[%
    ...
    % oneside,          % einseitig (removed)
    % listof=totoc,     % alle Verzeichnisse in ToC einbinden (removed)
    bibliography=totoc,
    toc=listof,
...
\setlength{\headheight}{50.92297pt} % Increase headheight
\addtolength{\topmargin}{-32.79797pt} % Adjust topmargin
